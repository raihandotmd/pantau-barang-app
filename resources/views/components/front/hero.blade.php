...
<div class="relative bg-pantau-dark pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center gap-4">
            <a href="{{ route('store.products', $store->slug) }}" class="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-pantau-dark bg-white md:py-4 md:text-lg md:px-10 shadow-lg transition-transform transform hover:scale-105">
                Belanja Sekarang
                <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </a>
            <a href="{{ route('store.profile', $store->slug) }}" class="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-pantau-medium bg-opacity-60 hover:bg-opacity-70 md:py-4 md:text-lg md:px-10 backdrop-blur-sm hover:scale-105">
                Profil Toko
            </a>
        </div>
    </div>
