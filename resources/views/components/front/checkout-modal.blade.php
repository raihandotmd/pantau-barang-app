...
}" @open-checkout.window="open = true; initMap()" @keydown.escape.window="open = false" class="relative z-[70]"
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                            ...
                            <form @submit.prevent="submitOrder" class="mt-6 space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" x-model="form.customer_name" required
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pantau-medium focus:ring-pantau-medium sm:text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">WhatsApp Number</label>
                                        <input type="text" x-model="form.customer_phone" required placeholder="08..."
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pantau-medium focus:ring-pantau-medium sm:text-sm">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea x-model="form.customer_address" rows="2" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pantau-medium focus:ring-pantau-medium sm:text-sm"></textarea>
                                </div>
