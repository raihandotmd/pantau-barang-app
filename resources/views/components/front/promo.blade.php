<div class="bg-gray-900">
    <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 lg:py-24 lg:flex lg:items-center lg:justify-between">
        <div class="lg:w-1/2">
            <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-pantau-dark text-pantau-sand mb-4">
                Platform Multi-Vendor
            </span>
            <h2 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                <span class="block">Buka Toko Online &</span>
                <span class="block text-pantau-light">Jual Spareparts Motor Anda</span>
            </h2>
            ...
            <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="flex items-center">
                    <svg class="h-6 w-6 text-pantau-light" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            ...
            <div class="mt-10">
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-pantau-medium hover:bg-pantau-dark">
            ...
            <div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-700">
                <div class="p-6 sm:p-10">
                    <div class="flex items-center gap-4 mb-6">
                        <div class="bg-pantau-dark p-3 rounded-lg">
                            <svg class="w-8 h-8 text-pantau-light" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="bg-pantau-dark p-3 rounded-lg">
                            <svg class="w-8 h-8 text-pantau-light" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        </div>
                        <div>
