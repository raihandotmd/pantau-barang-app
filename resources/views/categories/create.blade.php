        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Tips for Category Names</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc pl-5 space-y-1">
                                <li>Use clear, descriptive names that make sense for your business</li>
                                <li>Keep names concise but specific (e.g., "Men's Shoes" vs "Shoes")</li>
                                <li>Categories help you organize items and generate better reports</li>
                                <li>You can always edit or delete categories later if needed</li>
                            </ul>
                        </div>
                    </div>
                </div>
